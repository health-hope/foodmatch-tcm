<template>
    <div v-show="homeShow" class="home" :style="{ backgroundImage: `url(${ homeData.imageUrl })`}">
        <!-- 内容 -->
        <div class="ctn">
            <!-- 适合人群 -->
            <div class="ctn-top">
        ...
        <!-- 参考文献 -->
        <div class="ctn pro-endorsement" v-if="homeData.proEndorsement">
            <dl>
                <dt>参考文献</dt>
        ...
        <!-- 开始配餐 -->
        <div class="button" :style="{backgroundImage: 'url(sy_button_bg.png)'}  | PUBLIC_PATH"  @click="start">开始配餐</div>
    </div>
</template>
<script>
    ...
    methods: {
        async getBrief() {
            if(this.code && this.userId){
                ...
                if(foodStatus.foodMatch.foodMatchStatus == 1){//配餐中
